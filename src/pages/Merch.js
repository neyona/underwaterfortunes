      ...
      <div>
         <Container>
           <Jumbotron className="jumbotron-merch">
             <u><a href="https://www.teepublic.com/user/neyona" target="_blank" rel="noopener noreferrer" className="link">
               <h2>Merchandise of ME!</h2>
            </a></u>
           <Row>
             <Col xs={12} sm={9} className="main-section">
               <p>
                 Did you enjoy this site? I hope you did. Merchandise of me, the beautiful handsome Fortune Giver, can be found here at <u><a href="https://www.teepublic.com/user/neyona" target="_blank" rel="noopener noreferrer" className="link">Tee Public</a></u>.
                    See, it's me on the merchandise and I am gorgeous. You can click on the pictures on this page to get to the store and these items. These fun items use art made by Meghan Myers.
                  </p>
             </Col>
          ...
          <Row>
             <Col xs={12} sm={4} className="sidebar-section">
               ...
               <Image src={Stolen_Memories} className="img-purple" fluid />
               </a>
             </Col>
